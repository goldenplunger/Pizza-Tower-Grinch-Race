function scr_player_pizzathrow()
{
	...
	if ((global.shroomfollow == 1 or global.cheesefollow == 1 or global.tomatofollow == 1 or global.sausagefollow == 1 or global.pineapplefollow == 1) && !instance_exists(obj_toppinsacrifice))
	{
