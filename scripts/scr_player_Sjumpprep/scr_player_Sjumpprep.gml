...
{	
	...
	if (sprite_index == spr_player_superjumppreplight or sprite_index == spr_player_superjumpright or sprite_index == spr_player_superjumpleft)
	{
	    if (!place_meeting(x, y + 1, obj_railh) && !place_meeting(x, y + 1, obj_railh2))
	        hsp = move * 2;
	    else if (place_meeting(x, y + 1, obj_railh))
	...
	if (!key_up && (sprite_index == spr_player_superjumppreplight or sprite_index == spr_player_superjumpleft or sprite_index == spr_player_superjumpright) && !place_meeting(x, y - 16, obj_collisionparent) && !place_meeting(x, y - 32, obj_collisionparent))
	{
