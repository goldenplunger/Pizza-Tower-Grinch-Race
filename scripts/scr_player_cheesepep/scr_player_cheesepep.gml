function scr_player_cheesepep()
{
	...
	if ((input_buffer_jump < 8 && vsp > 0) && place_meeting(x, y + 1, obj_collisionparent) && (sprite_index == spr_cheesepep_idle or sprite_index == spr_cheesepep_walk))
	{
	...
	if ((floor(image_index) == (image_number - 1) && sprite_index == spr_cheesepep_jump) or (!place_meeting(x, y + 1, obj_collisionparent) && sprite_index != spr_cheesepep_jump) or (vsp > 0 && sprite_index == spr_cheesepep_jump))
