...
if (place_meeting(x, y - 1, obj_player) && (obj_player.x >= (x - 8) && obj_player.x <= (x + 8)) && (obj_player.state == states.normal or obj_player.state == states.crouch or obj_player.state == states.mach1))
{
