if ((place_meeting(x, y, obj_player) && obj_player.attacking == 1) or place_meeting(x, y, obj_chainsawhitbox) or place_meeting(x, y, obj_slaphitbox) or place_meeting(x, y, obj_shotgunbullet) or (place_meeting(x, y, obj_pistolbullet) && sprite_index == spr_pizzaboxunopen))
{
