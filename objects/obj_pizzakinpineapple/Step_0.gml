...
if (global.pineapplefollow == 1)
{
    ...
    if (place_meeting(x, y, obj_water2) or place_meeting(x, y, obj_water))
...
if ((obj_player.state == states.hurt or obj_player.state == states.current) && global.pineapplefollow == 1)
