...
if (stunhp == 0 && !(stunned == 1 && alarm[1] > 40) && slapped == 0 && (sprite_index == normalspr or sprite_index == stunspr))
{
...
else if (slapped == 0 && (sprite_index == normalspr or sprite_index == stunspr))
{
